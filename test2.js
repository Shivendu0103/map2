...
function drawVisualization() {
    var data = google.visualization.arrayToDataTable([
        ...
        ['IN-HR', 'Haryana', 1],
        ['IN-JK', 'Jammu and Kashmir', 1],   // Jammu and Kashmir added correctly
        ['IN-LA', 'Ladakh', 1],              // Ladakh added separately since it is a UT now
        ['IN-UT', 'Uttarakhand', 1],
        ...
        ['IN-NL', 'Nagaland', 1],
        ['IN-GA', 'Goa', 3],
        ['IN-AR', 'Arunachal Pradesh', 1],   // Arunachal Pradesh handled properly
        ['IN-MZ', 'Mizoram', 1],
        ['IN-SK', 'Sikkim', 1],
        ['IN-DL', 'Delhi', 1],
        ['IN-PY', 'Puducherry', 3],
        ...
        ['IN-DN', 'Dadra and Nagar Haveli and Daman and Diu', 1], // Combined DNH and Daman and Diu
        ['IN-LD', 'Lakshadweep', 1]
      ]);
